...
module.exports = {
  ...
  API: {
    ...
    RECOMMENDED_COURSE: `${base_link_api}/api/v2/courses?exclude=ratings&filter%5Brecommended%5D=true&filter%5Bunlisted%5D=false&include=instructors%2Cruns&sort=difficulty`,
